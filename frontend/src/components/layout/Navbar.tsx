          ...
          <div className="grid grid-cols-[auto_1fr_auto] md:grid-cols-[1fr_auto_1fr] items-center gap-2 py-2.5">
            ...
            <div className="hidden md:flex items-center gap-2 justify-self-end">
              <Link
                to="/partner-plans"
                className={cn(
                  "inline-flex items-center gap-2 rounded-2xl px-4 py-2.5 text-xs font-black uppercase tracking-[0.12em] shadow-lg shadow-rose-900/15 transition-all",
                  pathname.startsWith("/partner-plans")
              ...
              >
                ...
                <span className="rounded-full bg-white px-2 py-0.5 text-[10px] font-black text-[#be123c]">
                  Rs 365
                </span>
              </Link>
